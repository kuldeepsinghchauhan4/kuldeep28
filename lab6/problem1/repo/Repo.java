package com.cg.eis.lab6.problem1.repo;

import java.util.Scanner;

import com.cg.eis.lab6.problem1.Exception.InvailidNameException;
import com.cg.eis.lab6.problem1.bl.PersonSchedular;
...
public class Repo {
	...
	private static void addPerson() {
		...
		} catch(InvailidNameException e) {
			System.out.println("Do not Leave Name as blank");
		}
